...
@SpringBootTest(properties = { "grpc.server.port=9091" }) // Use fixed port for integration test
@ActiveProfiles("test")
...
class WarehouseGrpcIntegrationTest {
        ...
        void setup() {
                ...
                // Use fixed port 9091 for integration testing
        ...
        private void setupTestData() {
                ...
                // Create test inventory for warehouse 2 (smaller quantity for multi-warehouse
                // testing)
        ...
        void testCommitStock_Success_WithDeliveryPackages() {
                ...
                // Verify warehouse address contains expected components (warehouse order may
                // vary)
                assertThat(pkg.getWarehouseAddress()).containsAnyOf("123 George Street", "456 Collins Street");
                assertThat(pkg.getWarehouseAddress()).containsAnyOf("Sydney", "Melbourne");
                ...
                reservations.forEach(res -> assertThat(res.getStatus()).isEqualTo(Reservation.Status.COMMITTED));
        }
        ...
        void testRollbackStock_Success() {
                ...
                java.util.List<Reservation> reservations = reservationRepository.findByOrderId(orderId);
                assertThat(reservations).isNotEmpty();
                reservations.forEach(res -> assertThat(res.getStatus()).isEqualTo(Reservation.Status.ROLLED_BACK));
        }
        ...
        void testReserveStock_MultipleWarehouses() {
                ...
                // Step 6: Verify total remaining stock across all warehouses
                // Initially: 100 + 50 = 150 units
                // After reservation: 150 - 120 = 30 units remaining
                int totalRemainingStock = inventoryRepository.sumQuantityByProductId(productId);
                assertThat(totalRemainingStock).isEqualTo(30);
        }
}
