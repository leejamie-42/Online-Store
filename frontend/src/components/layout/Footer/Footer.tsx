...
import { LuShoppingCart, LuMail, LuPhone, LuMapPin } from 'react-icons/lu';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link to={ROUTES.HOME} className="flex items-center space-x-2 mb-4">
              <LuShoppingCart className="h-8 w-8 text-primary-400" />
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-2">
                <LuMapPin className="h-5 w-5 text-primary-400 flex-shrink-0 mt-0.5" />
                <span className="text-sm">123 Store Street, Sydney NSW 2000</span>
              </li>
              <li className="flex items-center space-x-2">
                <LuPhone className="h-5 w-5 text-primary-400 flex-shrink-0" />
                <span className="text-sm">+61 2 1234 5678</span>
              </li>
              <li className="flex items-center space-x-2">
                <LuMail className="h-5 w-5 text-primary-400 flex-shrink-0" />
